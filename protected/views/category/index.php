...
<div style="float:left">
  <input id="reload"  type="button" style="display:block; clear: both;" value="Refresh"class="client-val-form btn btn-primary">
</div>
<div style="float:left;margin-left: 10px;">
  <input id="add_root" type="button" style="display:block; clear: both;" value="Create Root" class="client-val-form btn btn-primary">
</div>
</div>
