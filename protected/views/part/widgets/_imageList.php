...
if(!empty($model->images)){
    ...
    if($edit){
        foreach ($images as $image) {
            ...
            if($edit) echo CHtml::link('<span class="badge badge-important"><i class="icon-remove-sign icon-white"></i> remove</span>',array('part/removeImage','id'=>$model->id,'image_id'=>$image->id)) . '<br /><br />'; 
        }
    } else {
